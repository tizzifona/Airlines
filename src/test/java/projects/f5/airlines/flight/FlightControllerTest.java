...
class FlightControllerTest {
    ...
    void testCreateFlight() throws Exception {
        FlightDto flightDto = new FlightDto(1L, "JFK", "LAX", LocalDateTime.now(), LocalDateTime.now().plusHours(5),
    ...
    void testSearchFlights() throws Exception {
        ...
        when(flightService.searchFlights(any(FlightSearchDto.class))).thenReturn(Collections.singletonList(flightDto));
